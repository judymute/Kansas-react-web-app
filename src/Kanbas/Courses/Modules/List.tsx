        ...
        <div className="btn-group-row">
          ...
          <div className="dropdown-container">
            <select className="dropdown-flat">
              <option>    <FaCheckCircle className="text-success check-circle-icon" />   Publish All</option>
                ...
                <li key={index}
                  ...
                  <div className="module-header-container" >
                    ...
                    <span className="module-icons float-end">
                      <FaCheckCircle className="icon module-icons text-success check-circle-icon" />
                      <BsPlusLg className="module-icons plus-icon ms-2 me-3" />
                      ...
                      {module.lessons?.map((lesson: { name: string }, index: number) => (
                        <li className="list-group-item-inner" key={index}>
                          ...
                          <span className="float-end">
                            <FaCheckCircle className="text-success check-circle-icon" />
